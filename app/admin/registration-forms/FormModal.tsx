          ...
          {activeTab === 'design' && (
            <div className="space-y-4">
              <div>
                ...
                />
                <p className="text-xs text-gray-400 mt-1">Displayed at the top of registration form</p>
                {formData.hero_image_url && (
                  <img src={formData.hero_image_url} alt="Hero" className="mt-2 w-full h-40 object-cover rounded-lg" />
                )}
              </div>
